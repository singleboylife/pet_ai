-- ============================================================
--  宠医宝 MySQL 数据库完整初始化脚本
--  包含：schema.mysql.sql + migrations/001~003
--  使用方法：mysql -u root -p pet_mysql < init.sql
-- ============================================================

CREATE DATABASE IF NOT EXISTS pet_mysql DEFAULT CHARSET utf8mb4;
USE pet_mysql;
...
-- ------------------------------------------------------------
-- 商品表（含 002_products_upgrade 的字段）
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS products (
  id             INT UNSIGNED  AUTO_INCREMENT PRIMARY KEY,
  merchant_id    INT UNSIGNED  DEFAULT 0,
  shop_type      ENUM('self','third_party') DEFAULT 'self',
...
-- ------------------------------------------------------------
-- 订单表（含 003_orders_upgrade 的 merchant_orders 字段）
-- ------------------------------------------------------------
...
('admin', '$2a$10$KPS1uhWltJs2mQSaF8cpZOqC2qm.SE5lKbdipg58PZqFaZ4JG2n2u', '管理员', 'admin');
